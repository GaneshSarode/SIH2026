...
import { Search, Activity, CheckCircle2, AlertTriangle, LogIn, X } from "lucide-react";
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    <span className="font-semibold">{home.id}</span>
                  ...
                  <div className="flex items-center gap-1.5 w-20 justify-end">
                    {isTargetHome ? (
                      ...
                      <>
                        ...
                        <span className="text-xs font-medium text-[var(--color-status-warning)]">Low</span>
                      </>
                    )}
                  </div>
                </div>
